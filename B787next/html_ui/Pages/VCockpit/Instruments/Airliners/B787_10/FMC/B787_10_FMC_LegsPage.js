class B787_10_FMC_LegsPage {
    static ShowPage1(fmc, currentPage = 1, step = 0) {
        ...
        fmc.pageUpdate = () => {
            ...
            if (B787_10_FMC_LegsPage._timer >= 100) {
                ...
                for (let i = 0; i < 5; i++) {
                    ...
                    if (waypoint) {
                        ...
                        if (isEnRouteWaypoint) {
                            rows[2 * i + 1][1] = fmc.getCrzManagedSpeed(true).toFixed(0) + "/ FL" + fmc.cruiseFlightLevel.toFixed(0);
                        }
                        else {
                            let speedConstraint = "---";
                            ...
                            if (waypoint.legAltitudeDescription !== 0) {
                                ...
                                if (isLastDepartureWaypoint || isFirstArrivalWaypoint) {
                                    altitudeConstraint = "FL" + fmc.cruiseFlightLevel.toFixed(0);
                                }
                            }
